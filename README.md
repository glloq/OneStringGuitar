...
#### avantages :
- delais le plus court
#### Inconvenients :
- bruyant
- necessite un refroidissement passif ou actif
...
-----------------------------------------------------------------
## servommoteurs
en utilisant des pca9685 nous pouvons facilement controller 16 servomoteurs
#### avantages :
- le plus simple a configurer
#### Inconvenients :
- delais d'action important
